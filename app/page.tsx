...
import { TrendingUp, Zap, Shield, Target, Users, Star, Check, ArrowRight, Play, ExternalLink, Moon, Sun, LogIn } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-gray-900 dark:to-slate-900 relative overflow-hidden">
      {/* Animation de bougies en arrière-plan */}
      <CandlestickAnimation />
      
      {/* Header */}
      <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl shadow-sm sticky top-0 z-50 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">A2Sniper Binaire</h1>
                <p className="text-xs text-blue-600 dark:text-blue-400">Plateforme Trading IA</p>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              ...
              <Link 
                href="/dashboard" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg"
              >
                Dashboard
              </Link>
            </div>
          ...
          <div className="text-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 dark:text-white">
                  Propulsé par l'IA
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button 
                  ...
                  disabled={showDemo}
                  className="border-2 border-blue-500 text-blue-600 dark:text-blue-400 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all flex items-center space-x-2 disabled:opacity-50"
                >
                  {showDemo ? (
                    <>
      ...
      {/* Features Section */}
      <section className="py-20 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
              Pourquoi choisir A2Sniper Binaire ?
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className={`relative bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all ${
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="text-4xl font-bold text-gray-900 dark:text-white mb-1">
                    ${plan.price}
                    <span className="text-lg font-normal text-gray-600 dark:text-gray-400">/mois</span>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Rejoignez des milliers de traders qui génèrent des profits constants avec A2Sniper Binaire
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/dashboard" 
      ...
      {/* Footer */}
      <footer className="bg-gray-900 dark:bg-black text-white py-12 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Newsletter */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">A2Sniper Binaire</span>
              </div>
              <p className="text-gray-400">
                Plateforme de trading binaire propulsée par l'IA
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 A2Sniper Binaire. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
